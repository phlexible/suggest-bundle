Ext.provide('Phlexible.suggest.MetaSuggestWindow');

Phlexible.suggest.MetaSuggestWindow = Ext.extend(Ext.Window, {
    width: 400,
    height: 350,
    layout: 'fit',
    modal: true,
    ...
    initComponent: function () {
        ...
        Phlexible.suggest.MetaSuggestWindow.superclass.initComponent.call(this);
    }
});
